...
var Leads = function Leads() {
  ...
  var handlerClickRemove = function handlerClickRemove(currentId) {
    ...
    Object(_actions_form__WEBPACK_IMPORTED_MODULE_7__["removeFormData"])(id, token).then(function (data) {
      if (data.error) {
